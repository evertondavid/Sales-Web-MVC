// Purpose: This class is used to seed the database with some initial data. This is useful for testing purposes.
...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        private SalesWebMvcDbContext _context;

        // Constructor that receives the database context instance via dependency injection
        public SeedingService(SalesWebMvcDbContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            {
                return; // If there is data, the database has been seeded, so we return
            }
            ...
            // Create some sellers
            Seller s1 = new(1, "Bob Brown", "bog@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            ...
            Seller s6 = new(6, "Alex Pink", "alexp@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
            ...
            // Add the created data to the database context
